...
<details>
  ...
  <br><br>
  <ul>
    <li><strong>Genomic Annotation Service Project</strong>strong>: AWS (CloudFormation, CloudWatch, DynamoDB, EC2, IAM, Lambda, S3, SNS/SQS); HTML (Bootstrap); Jinja; Flask; authentication; Stripe integration; shell scripting</li>
  </ul>
</details>
