...
- 💸 **[Predicting Poverty using a Proxy Means Test](https://github.com/m-rosenbaum/cr_pmt/)** (2024 | Python): Constructed a proxy means test to predict income categories from Costa Rican household survey data using supervised machine learning techniques. Example machne learning pipeline produced with a team of 3 as part of a class project in the second quarter of a CS program. My contributions included sampling and tuning.
